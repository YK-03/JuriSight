...
export function Logo({
  ...
  return (
    <Link href={href} className={cn("group inline-flex items-center gap-2.5", className)}>
      <span className="inline-flex h-9 w-9 items-center justify-center rounded-lg border border-border bg-bg-card transition-all duration-300 group-hover:border-accent/70 group-hover:shadow-[0_0_0_1px_rgb(var(--accent)/0.22)]">
        <svg
          viewBox="0 0 24 24"
          aria-hidden
          className="h-5 w-5 text-accent transition-transform duration-300 group-hover:scale-105"
          fill="none"
          stroke="currentColor"
          strokeWidth="1.7"
          strokeLinecap="round"
